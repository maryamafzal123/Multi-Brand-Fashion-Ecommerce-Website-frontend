    ...
    <section style={{ padding: '4rem 6vw 6rem', background: '#fff' }}>
      <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        <h2 style={{
          ...
          fontWeight: 300, color: '#111', letterSpacing: '0.06em',
        }}>
...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        const firstVideo = images.find((img: { image: string }) =>
          /\.(mp4|mov|avi|webm|mkv)$/i.test(img.image)
        );
  ...
  // Helper — is this line a section heading?
  const isHeading = (line: string) =>
    /^(Shirt|Dupatta|Trouser|Kameez|Shalwar|Trousers)$/i.test(line.trim());
  ...
  color: '#b8960c', letterSpacing: '0.05em',
}}>
                  ...
                  {product.variants.map((variant) => (
                    <button
                      ...
                      style={{
                        ...
                        fontSize: '0.78rem',
                        background: selectedVariant?.id === variant.id ? '#111' : 'transparent',
                        color: selectedVariant?.id === variant.id ? '#faf8f5' : '#111',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <button
                  ...
                  style={{
                    ...
                    fontSize: '1.2rem', cursor: 'pointer', color: '#111',
                  }}
                >−</button>
                <span style={{
                  fontFamily: "'Jost', sans-serif",
...
>+</button>
            ...
            {/* WhatsApp Order */}
            <a
              href={`https://wa.me/923336262574?text=Hi! I want to order: ${product.name}`}
              target="_blank"
